...
BLOG_AUTHOR = "Glenn Fung"  # (translatable)
BLOG_TITLE = "Machine Learning Research and Innovation Group"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://www.ai-ml-amfam.com/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://www.ai-ml-amfam.com/"
BLOG_EMAIL = "gfung@amfam.com"
BLOG_DESCRIPTION = "The Machine Learning Research and Innovation Group at American Family Insurance aims at providing innovative and efficient AI and data science-inspired solutions to the enterprise.  We coordinate ML and AI research with labs and universities and explore how recent advances in the area could impact problems relevant to the insurance domain."  # (translatable)
